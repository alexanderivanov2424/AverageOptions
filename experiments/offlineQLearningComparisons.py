...
def make_option_agent(mdp, nx_graph, Matrix, intToS, method='eigen'):
    ...
    return OptionAgent(method + "-options", mdp.actions, call_back, default_q=0.0, option_q=0.0, alpha=.1)
...
def make_plot(dom, task="", rand_init_and_goal=True, n_options=8, n_instances=10, n_episodes=100, n_steps=500):
    ...
    if dom == 'grid':
        ...
        mdp = HanoiMDP(num_pegs=3, num_discs=6, rand_init_goal=rand_init_and_goal, step_cost=0.0)
    elif dom == 'track':
    ...
    ql_agent = QLearningAgent(actions=mdp.get_actions(), default_q=0.0, alpha=.1)
    ...
    filename = f'offline_{exp_name}_inst{n_instances}_ep{n_episodes}_op{n_options}'
...
use_ASPDM = True
make_plot("grid", task="9x9grid", rand_init_and_goal=RAND_INIT, n_options=n_options, n_instances=n_instances, n_episodes=episodes, n_steps=n_steps)
make_plot("grid", task="fourroom", rand_init_and_goal=RAND_INIT, n_options=n_options, n_instances=n_instances, n_episodes=episodes, n_steps=n_steps)
make_plot("hanoi", rand_init_and_goal=RAND_INIT, n_options=n_options, n_instances=n_instances, n_episodes=episodes, n_steps=n_steps)

use_ASPDM = False
make_plot("track", task="Track1", rand_init_and_goal=RAND_INIT, n_options=n_options, n_instances=n_instances, n_episodes=episodes, n_steps=n_steps)
make_plot("taxi", rand_init_and_goal=RAND_INIT, n_options=n_options, n_instances=n_instances, n_episodes=episodes, n_steps=n_steps)
make_plot("grid", task="Parr", rand_init_and_goal=RAND_INIT, n_options=n_options, n_instances=n_instances, n_episodes=episodes, n_steps=n_steps)

# make_plot("grid", task="100x100grid", rand_init_and_goal=RAND_INIT, n_options=n_options, n_instances=n_instances, n_episodes=episodes, n_steps=n_steps)
# make_plot("grid", task="100x100fourroom", rand_init_and_goal=RAND_INIT, n_options=n_options, n_instances=n_instances, n_episodes=episodes, n_steps=n_steps)


#https://www.dcode.fr/maze-generator
# make_plot("grid", task="maze1", rand_init_and_goal=RAND_INIT, n_options=n_options, n_instances=n_instances, n_episodes=episodes, n_steps=n_steps)
# make_plot("grid", task="maze2", rand_init_and_goal=RAND_INIT, n_options=n_options, n_instances=n_instances, n_episodes=episodes, n_steps=n_steps)
# make_plot("grid", task="maze3", rand_init_and_goal=RAND_INIT, n_options=n_options, n_instances=n_instances, n_episodes=episodes, n_steps=n_steps)
# make_plot("grid", task="maze4", rand_init_and_goal=RAND_INIT, n_options=n_options, n_instances=n_instances, n_episodes=episodes, n_steps=n_steps)


# make_plot("hanoi-L", rand_init_and_goal=RAND_INIT, n_options=n_options, n_instances=n_instances, n_episodes=episodes, n_steps=n_steps)
# make_plot("taxi-L", rand_init_and_goal=RAND_INIT, n_options=n_options, n_instances=n_instances, n_episodes=episodes, n_steps=n_steps)
